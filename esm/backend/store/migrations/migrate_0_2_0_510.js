import { BACKEND_API_URL, defaultPreferences, getLogger, } from "@coral-xyz/common";
import * as crypto from "../../keyring/crypto";
import { getKeyringCiphertext, setKeyringStore } from "../keyring";
import { getWalletData_DEPRECATED, setWalletData_DEPRECATED, setWalletDataForUser, } from "../preferences";
...
async function migrateUserData_0_2_0_510(userInfo, username) {
...
//     multi user format.
export async function migrateKeyringStore_0_2_0_510(userInfo, username) {
        ...
        users: Object.fromEntries([
            [
                uuid,
                {
                    ...
                    username,
                    mnemonic,
                    activeBlockchain: Object.keys(blockchains)[0],
                    blockchains,
                },
            ],
        ]),
...
//# sourceMappingURL=migrate_0_2_0_510.js.map