...
async function _runMigrationsIfNeeded(userInfo) {
    ...
    //
    if ((lastMigration === null || lastMigration === void 0 ? void 0 : lastMigration.state) === "finalized" &&
        (lastMigration === null || lastMigration === void 0 ? void 0 : lastMigration.build) === LATEST_MIGRATION_BUILD) {
    ...
    // exit with an error.
    //
    if (lastMigration !== undefined && (lastMigration === null || lastMigration === void 0 ? void 0 : lastMigration.state) === "start") {
    ...
    if (((_a = (await getMigration())) === null || _a === void 0 ? void 0 : _a.build) === 510) {
    ...
    if (finalMigration === undefined ||
        (finalMigration === null || finalMigration === void 0 ? void 0 : finalMigration.build) !== LATEST_MIGRATION_BUILD ||
        (finalMigration === null || finalMigration === void 0 ? void 0 : finalMigration.state) !== "finalized") {
        await setMigration({
...
async function runMigration(build, fn) {
...
async function pushMigrationLog(m) {
